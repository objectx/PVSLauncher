...
[<assembly: AssemblyTitleAttribute("PVSLauncher.Tests")>]
[<assembly: AssemblyProductAttribute("PVSLauncher")>]
...
module internal AssemblyVersionInformation =
    let [<Literal>] AssemblyTitle = "PVSLauncher.Tests"
    let [<Literal>] AssemblyProduct = "PVSLauncher"
